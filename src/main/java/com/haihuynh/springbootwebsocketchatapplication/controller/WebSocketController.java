...
public class WebSocketController {
	...
	public void onReceiveUpdateTitleAndDescription(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"[user:" + message.getUserId() + " sharing title and description: " + message.getRaumTitle() + " - "
						+ message.getRaumDescription() + "]");
	}
	...
	public void onReceiveMessage(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"[user:" + message.getUserId() + " sends chat-message: " + message.getChatMessage() + "]");
	}
	...
	public void onCreateRaum(@Nullable final Message message) {
		...
		sendResponseMessage(responseMessage, message,
				"userId: " + responseMessage.getUserId() + " -> [created room - " + responseMessage.getRaumId()
						+ " |  status: " + syncService.getRaum(responseMessage.getRaumId()).getRaumStatus() + "]");
	}
	...
	public void onReceiveChangeUserName(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"user: " + message.getUserId() + " -> [changed name to - " + message.getUserName() + "]");
	}
	...
	public void onJoinRoom(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"user: " + message.getUserId() + " -> [joined room - " + message.getRaumId() + "]");
	}
	...
	public void onDisconnectClient(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"user: " + message.getUserId() + " -> [left room - " + message.getRaumId() + "]");
	}
	...
	public void onReceiveSyncTimeStamp(@Nullable final Message message) {
		...
		sendResponseMessage(responseMessage, message,
				"[receive sync timestamp from User " + responseMessage.getUser() + "]");
	}
	...
	public void onReceiveSeekToTimeStamp(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"user: " + message.getUserId() + "-> [jumps in room - " + message.getRaumId() + "]");
	}
	...
	public void onReceiveTogglePlay(@Nullable final Message message) {
		...
		if (responseMessages != null) {
			System.out.println(
					"user: " + message.getUserId() + " -> [toggle play in room - " + message.getRaumId() + "]");
	...
	public void onReceiveAssignAdmin(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message, "[user: " + message.getAssignedUser().getUserId()
				+ " has been assigned admin by " + message.getUserId() + "]");
	}
	...
	public void onReceiveToPublicRoomRequest(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"[user: " + message.getUserId() + " has set room " + message.getRaumId() + " to public]");
	}
	...
	public void onReceiveKickUser(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message, "[user: " + message.getUserId() + " has kicked User: "
				+ message.getAssignedUser().getUserId() + "from room:" + message.getRaumId() + "]");
	}
	...
	public void onReceivePardonKickedUser(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message, "[user: " + message.getUserId() + " has pardonded User: "
				+ message.getAssignedUser().getUserId() + "from room:" + message.getRaumId() + "]");
	}
	...
	public void onReceiveAddVideoToPlaylist(@Nullable final Message message) {
		List<Message> responseMessages = this.syncService.addVideoToPlaylistMessages(message,
				SyncService.AddVideoMode.LAST);
		sendResponseMessages(responseMessages, message, "[user: " + message.getUserId() + " added video "
				+ message.getPlaylistVideo().getVideoId() + "to playlist as Last]");
	}
	...
	public void onReceiveAddVideoToPlaylistAsNext(@Nullable final Message message) {
		List<Message> responseMessages = this.syncService.addVideoToPlaylistMessages(message,
				SyncService.AddVideoMode.NEXT);
		sendResponseMessages(responseMessages, message, "[user: " + message.getUserId() + " added video "
				+ message.getPlaylistVideo().getVideoId() + "to playlist as Next]");
	}
	...
	public void onReceiveAddVideoToPlaylistAsCurrent(@Nullable final Message message) {
		List<Message> responseMessages = this.syncService.addVideoToPlaylistMessages(message,
				SyncService.AddVideoMode.CURRENT);
		sendResponseMessages(responseMessages, message, "[user: " + message.getUserId() + " added video "
				+ message.getPlaylistVideo().getVideoId() + "to playlist as current]");
	}
	...
	public void onReceiveRemoveVideoFromPlaylist(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"[video removed from playlist by user " + message.getUser() + "]");
	}
	...
	public void onReceiveSwitchPlaylistVideo(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message, "[switched playlist video by user " + message.getUser() + " to "
				+ message.getPlaylistVideo().getTitle() + "]");
	}
	...
	public void onReceiveTogglePlaylistRunningOrder(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"[playlist-running-order toggled by user " + message.getUser() + "]");
	}
	...
	public void onReceiveToggleMuteUser(@Nullable final Message message) {
		...
		sendResponseMessages(responseMessages, message,
				"[toggle-mute-user " + message.getAssignedUser() + " by User" + message.getUser() + "]");
	}
	...
	public void onReceiveRequestSyncTimestamp(@Nullable final Message message) {
		...
		sendResponseMessage(responseMessage, message,
				"[requested sync timestamp from User " + responseMessage.getUser() + "]");
	}
